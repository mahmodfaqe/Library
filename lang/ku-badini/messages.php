...
return [
    ...
    'hero_eyebrow' => '<h2 style="font-size:clamp(1rem,3vw,1.3rem);">بخێر هاتن بۆ</h2>
...
<p class="mb-8 opacity-95 mx-auto max-w-3xl" style="font-size: clamp(0.95rem,2.5vw,1.25rem);">بهێسانی و زو پەیدابوونا بی هەزاران چاوکانی و پەرتوکین زانستی.</p>',
    'hero_title' => '<div class="text-center max-w-[900px] mx-auto">
...
<div class="text-center p-5 bg-white rounded-xl shadow-sm"><h4 class="font-bold text-[#2d2d3a] mb-2">محمود خدر فقێ ڕەسوڵ</h4><p class="text-[#6b6b80]">خینکارێ بایۆلۆجیێ - پێشدەبرێ مالپەرێ</p><div class="social-placeholder"></div></div>
    ...
    'services_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">📚 مێژووی پرتوکخانەیا کۆلێژا زانستێ</h2>
...
<p class="text-[#6b6b80] leading-[1.9] text-justify" style="font-size:clamp(0.95rem,2.5vw,1.15rem);">ئەڤ کرانەوە وەرگیرانا نوێ بوو ژ بۆ خوێندکار، مامۆستا و کارمەندێن کۆلێژا زانستێ، کو ئیستا بیهێسانی و بی زوانی دەستدا ب پرتوک و چاوکانیێن زانستی و ئەکادیمیک، و قەریقا فێربوونێ باştir û kalîtetir bibe.</p>
    ...
    'resources_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-6" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">کتێبخانەیا سەرەکە</h2><a href="https://drive.google.com/drive/folders/12PipzBzMVgfr1tFSy-4bplnVMnNHTy4d" class="main-library-btn relative inline-block font-bold text-white rounded-full no-underline text-center transition-all duration-300 hover:-translate-y-1.5" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); padding: clamp(0.9rem,3vw,1.15rem) clamp(2rem,6vw,3rem); font-size:clamp(0.95rem,2.5vw,1.15rem); box-shadow: 0 8px 24px rgba(255,107,107,0.35); min-width:200px;" target="_blank">بکەڤن کتێبخانەیا سەرەکە ١</a>',
    'main_library_btn' => 'بکەڤن کتێبخانەیا سەرەکە ٢',
    'about_block' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">👥 دەربارا مە</h2>
...
<p class="text-[#6b6b80] mb-0">"ڤەکرنا دەریێ ئاگەهداریێ ژ بۆ هەموو خوێندکاران و پەیداکرنا پلاتفۆرمەک کو بی ئاڤایەکی مودێرن هەموو پێداڤیێن ئەکادیمی پێک تینە &ldquo;</p>
    ...
    'feedback_success' => 'سپاس! ڕەخنە و پێشنیارا تە گەهیشت.',
    'feedback_error' => 'تکایە ڕەخنە یان پێشنیارا خۆ بنڤیسە.',
    'feedback_title' => '💬 ڕەخنە و پێشنیار',
    'feedback_subtitle' => 'ڕایا خۆ بە مە ڤە پارڤە بە دا باشترکرنا کتێبخانێ.',
    'fb_name_label' => 'ناڤ (ڤەدلێخواز)',
    'fb_msg_label' => 'ڕەخنە یان پێشنیار',
    'fb_send' => 'شاندن',
    'footer_copyright' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">کتێبخانەیا ئەلیکترۆنیکی یا کۆلێژا زانستێ - زانینگەها ڕاپەرین &nbsp;|&nbsp; هەموو ماف پاراستی نە &copy; <span class="footer-year-ar"></span></p>',
    'footer_uor_link' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">🎓 <a href="https://uor.edu.krd" target="_blank" rel="noopener" style="color:#9bb1ff; text-decoration:underline; text-underline-offset:3px;">ماڵپەڕا زانینگەها ڕاپەرین</a> &nbsp;|&nbsp; uor.edu.krd</p>',
