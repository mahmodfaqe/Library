...
return [
    ...
    'hero_eyebrow' => '<h2 style="font-size:clamp(1rem,3vw,1.3rem);">خۆش بگەیەیت بۆ</h2>
...
<div class="text-center p-5 bg-white rounded-xl shadow-sm"><h4 class="font-bold text-[#2d2d3a] mb-2">محمود خدر فقێ ڕەسوڵ</h4><p class="text-[#6b6b80]">خوێندکاری بەشی بایۆلۆجی - گەشەپێدەری وێبسایت</p><div class="social-placeholder"></div></div>
    ...
    'services_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">📚 مێژووی کتێبخانەی کۆلێژی زانست</h2>
...
<p class="text-[#6b6b80] leading-[1.9] text-justify" style="font-size:clamp(0.95rem,2.5vw,1.15rem);">کردنەوەی ئەم کتێبخانەیە پۆینتێکی نوێی گرنگ بوو بۆ خوێندکاران، مامۆستایان و فەرمانبەرانی کۆلێژی زانست، کە بە ئاسانی و خێرایی دەستیان گات بە کتێب و سەرچاوەی زانستی و ئەکادیمی، و پڕۆسەی فێربوون بەرزتر و باشتر بوو.</p>
    ...
    'resources_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-6" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">کتێبخانەی سەرەکی</h2><a href="https://drive.google.com/drive/folders/12PipzBzMVgfr1tFSy-4bplnVMnNHTy4d" class="main-library-btn relative inline-block font-bold text-white rounded-full no-underline text-center transition-all duration-300 hover:-translate-y-1.5" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); padding: clamp(0.9rem,3vw,1.15rem) clamp(2rem,6vw,3rem); font-size:clamp(0.95rem,2.5vw,1.15rem); box-shadow: 0 8px 24px rgba(255,107,107,0.35); min-width:200px;" target="_blank">بچۆ ناو کتێبخانەی گشتی ١</a>',
    'main_library_btn' => 'بچۆ ناو کتێبخانەی گشتی ٢',
    'about_block' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">👥 دەربارەی ئێمە</h2>
...
<p class="text-[#6b6b80] mb-0">"کردنەوەی دەرگای زانیاری بۆ هەموو خوێندکارێک و دابینکردنی یەک پلاتفۆرم کە هەموو پێداویستییەکانی ئەکادیمی دابین بکات بە شێوەیەکی مۆدێرن و سەردەمیانە &ldquo;</p>
    ...
    'feedback_success' => 'سوپاس! ڕەخنە و پێشنیارەکەت پێگەیشت.',
    'feedback_error' => 'تکایە ڕەخنە یان پێشنیارەکەت بنووسە.',
    'feedback_title' => '💬 ڕەخنە و پێشنیار',
    'feedback_subtitle' => 'ڕای خۆت لەگەڵمان بەش بکە بۆ باشترکردنی کتێبخانەکە.',
    'fb_name_label' => 'ناو (ئارەزوومەندانە)',
    'fb_msg_label' => 'ڕەخنە یان پێشنیار',
    'fb_send' => 'ناردن',
    'footer_copyright' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">کتێبخانەی ئەلیکترۆنی کۆلێژی زانست - زانکۆی ڕاپەڕین &nbsp;|&nbsp; هەموو مافەکان پارێزراون &copy; <span class="footer-year-ar"></span></p>',
    'footer_uor_link' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">🎓 <a href="https://uor.edu.krd" target="_blank" rel="noopener" style="color:#9bb1ff; text-decoration:underline; text-underline-offset:3px;">ماڵپەڕی زانکۆی ڕاپەڕین</a> &nbsp;|&nbsp; uor.edu.krd</p>',
