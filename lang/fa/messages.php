...
return [
    ...
    'hero_eyebrow' => '<h2 style="font-size:clamp(1rem,3vw,1.3rem);">خوش آمدید به</h2>
...
<div class="text-center p-5 bg-white rounded-xl shadow-sm"><h4 class="font-bold text-[#2d2d3a] mb-2">محمود خدر فقێ ڕەسوڵ</h4><p class="text-[#6b6b80]">دانشجوی گروه زیست‌شناسی - توسعه‌دهنده وب</p><div class="social-placeholder"></div></div>
    ...
    'services_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">📚 تاریخچه کتابخانه دانشکده علوم</h2>
...
<p class="text-[#6b6b80] mb-0">"گشودن دریچه‌ای به سوی اطلاعات برای هر دانش‌آموز و فراهم کردن بستری واحد که تمام نیازهای تحصیلی را به شیوه‌ای مدرن و امروزی برآورده می‌کند &ldquo;</p>
    ...
    'prefooter_note' => 'این وب‌سایت به عنوان یک مرکز در حال رشد، به‌طور مداوم توسط تیم BioNova نظارت و به‌روزرسانی می‌شود.',
    'feedback_success' => 'متشکریم! بازخورد شما دریافت شد.',
    'feedback_error' => 'لطفاً انتقاد یا پیشنهاد خود را بنویسید.',
    'feedback_title' => '💬 انتقادات و پیشنهادات',
    'feedback_subtitle' => 'برای بهبود کتابخانه نظر خود را با ما در میان بگذارید.',
    'fb_name_label' => 'نام (اختیاری)',
    'fb_msg_label' => 'انتقاد یا پیشنهاد',
    'fb_send' => 'ارسال',
    'footer_copyright' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">کتابخانه الکترونیکی دانشکده علوم - دانشگاه راپەرین &nbsp;|&nbsp; تمامی حقوق محفوظ است &copy; <span class="footer-year-ar"></span></p>',
    'footer_uor_link' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">🎓 <a href="https://uor.edu.krd" target="_blank" rel="noopener" style="color:#9bb1ff; text-decoration:underline; text-underline-offset:3px;">وب‌سایت دانشگاه راپەرین</a> &nbsp;|&nbsp; uor.edu.krd</p>',
