...
return [
    ...
    'hero_eyebrow' => '<h2 style="font-size:clamp(1rem,3vw,1.3rem);">Bi xêr hatin</h2>
...
<div class="text-center p-5 bg-white rounded-xl shadow-sm"><h4 class="font-bold text-[#2d2d3a] mb-2">MEHMÛD XIDIR FAQÊ RASÛL</h4><p class="text-[#6b6b80]">Xwendekarê Beşê Biyolojiyê - Pêşxistinkarê malperê</p><div class="social-placeholder"></div></div>
    ...
    'services_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">📚 Dîroka Pirtûkxaneya Koleja Zanistê</h2>
...
<p class="text-[#6b6b80] leading-[1.9] text-justify" style="font-size:clamp(0.95rem,2.5vw,1.15rem);">Vekirina vê pirtûkxaneyê xalek nû û girîng bû ji bo xwendekar, mamoste û karmendên Koleja Zanistê, û derfet da wan ku bi awayekî hêsantir û bilez bigihîjin pirtûk û çavkaniyên zanistî û akademîk, û pêvajoya fêrbûnê kalîtir û kêrhatîtir bibe.</p>
    ...
    'resources_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-6" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">Kitêbxaneya Sereke</h2><a href="https://drive.google.com/drive/folders/12PipzBzMVgfr1tFSy-4bplnVMnNHTy4d" class="main-library-btn relative inline-block font-bold text-white rounded-full no-underline text-center transition-all duration-300 hover:-translate-y-1.5" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); padding: clamp(0.9rem,3vw,1.15rem) clamp(2rem,6vw,3rem); font-size:clamp(0.95rem,2.5vw,1.15rem); box-shadow: 0 8px 24px rgba(255,107,107,0.35); min-width:200px;" target="_blank">Têkeve Kitêbxaneya Giştî 1</a>',
    'main_library_btn' => 'Têkeve Kitêbxaneya Giştî 2',
    'about_block' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">👥 Derbarê Me</h2>
...
<p class="text-[#6b6b80] mb-0">"Deriyê agahdariyê ji bo her xwendekarekî vedike û platformek yekane peyda dike ku hemî hewcedariyên akademîk bi awayekî nûjen û hemdem pêk tîne &ldquo;</p>
    ...
    'feedback_success' => 'Spas! Rexne û pêşniyara te gihîşt.',
    'feedback_error' => 'Ji kerema xwe rexne an pêşniyara xwe binivîse.',
    'feedback_title' => '💬 Rexne û Pêşniyar',
    'feedback_subtitle' => 'Nêrîna xwe bi me re parve bike ji bo çêtirkirina pirtûkxanê.',
    'fb_name_label' => 'Nav (dilxwaz)',
    'fb_msg_label' => 'Rexne an pêşniyar',
    'fb_send' => 'Bişîne',
    'footer_copyright' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">Kitêbxaneya Elektronîkî ya Kolêja Zanistê - Zanîngeha Raperin &nbsp;|&nbsp; Hemû maf parastî ne &copy; <span class="footer-year-en"></span></p>',
    'footer_uor_link' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">🎓 <a href="https://uor.edu.krd" target="_blank" rel="noopener" style="color:#9bb1ff; text-decoration:underline; text-underline-offset:3px;">Malpera Zanîngeha Raperîn</a> &nbsp;|&nbsp; uor.edu.krd</p>',
