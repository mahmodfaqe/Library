...
<head>
    ...
    <title>@yield('title', 'بەڕێوەبەری') — کتێبخانەی ئەلیکترۆنی</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        th, td { padding: 0.7rem 0.6rem; text-align: right; border-bottom: 1px solid #eef0f8; font-size: 0.92rem; vertical-align: middle; }
