...
return [
    ...
    'hero_eyebrow' => '<h2 style="font-size:clamp(1rem,3vw,1.3rem);">Hoş Geldiniz</h2>
...
<div class="text-center p-5 bg-white rounded-xl shadow-sm"><h4 class="font-bold text-[#2d2d3a] mb-2">MAHMOOD KHDIR FAQE RASUL</h4><p class="text-[#6b6b80]">Biyoloji Bölümü Öğrencisi - Web Geliştirici</p><div class="social-placeholder"></div></div>
    ...
    'services_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">📚 Fen Fakültesi Kütüphanesinin Tarihi</h2>
...
<p class="text-[#6b6b80] mb-0">"Her öğrenci için bilgiye erişim kapısını açmak ve tüm akademik ihtiyaçları modern ve çağdaş bir şekilde karşılayan tek bir platform sağlamak &ldquo;</p>
    ...
    'feedback_error' => 'Lütfen eleştirinizi veya önerinizi yazın.',
    'feedback_title' => '💬 Eleştiri ve Öneriler',
    'feedback_subtitle' => 'Kütüphaneyi geliştirmemize yardımcı olmak için görüşlerinizi paylaşın.',
    'fb_name_label' => 'İsim (isteğe bağlı)',
    'fb_msg_label' => 'Eleştiri veya öneri',
    'fb_send' => 'Gönder',
    'footer_copyright' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">Fen Fakültesi Elektronik Kütüphanesi - Raparin Üniversitesi &nbsp;|&nbsp; Tüm hakları saklıdır &copy; <span class="footer-year-en"></span></p>',
    'footer_uor_link' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">🎓 <a href="https://uor.edu.krd" target="_blank" rel="noopener" style="color:#9bb1ff; text-decoration:underline; text-underline-offset:3px;">Raparin Üniversitesi Web Sitesi</a> &nbsp;|&nbsp; uor.edu.krd</p>',
