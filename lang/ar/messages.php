...
return [
    ...
    'hero_eyebrow' => '<h2 style="font-size:clamp(1rem,3vw,1.3rem);">مرحبا بكم في</h2>
...
<div class="text-center p-5 bg-white rounded-xl shadow-sm"><h4 class="text-[#2d2d3a] mb-2 font-bold">محمود خدر فقێ ڕەسوڵ</h4><p class="text-[#6b6b80]">طالب قسم علوم الحياة - مطور مواقع الويب</p><div class="social-placeholder"></div></div>
    ...
    'services_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">📚 تاريخ مكتبة كلية العلوم</h2>
<div class="relative rounded-[18px] overflow-hidden shimmer-border reveal"
style="background: linear-gradient(145deg, #f5f7ff 0%, #eef0f8 100%); padding: clamp(1.5rem,5vw,3rem); box-shadow: 0 8px 32px rgba(102,126,234,0.15);">
...
<p class="text-[#6b6b80] mb-0">"فتح الباب أمام المعلومات لكل طالب وتوفير منصة واحدة تلبي جميع الاحتياجات الأكاديمية بطريقة حديثة ومعاصرة &ldquo;</p>
    ...
    'feedback_success' => 'شكرًا! تم استلام ملاحظاتك.',
    'feedback_error' => 'يرجى كتابة ملاحظتك أو اقتراحك.',
    'feedback_title' => '💬 الملاحظات والاقتراحات',
    'feedback_subtitle' => 'شاركنا رأيك لمساعدتنا على تحسين المكتبة.',
    'fb_name_label' => 'الاسم (اختياري)',
    'fb_msg_label' => 'ملاحظة أو اقتراح',
    'fb_send' => 'إرسال',
    'footer_copyright' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">المكتبة الإلكترونية لكلية العلوم - جامعة رابەرين &nbsp;|&nbsp; جميع الحقوق محفوظة &copy; <span class="footer-year-ar"></span></p>',
    'footer_uor_link' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">🎓 <a href="https://uor.edu.krd" target="_blank" rel="noopener" style="color:#9bb1ff; text-decoration:underline; text-underline-offset:3px;">الموقع الرسمي لجامعة رابەرين</a> &nbsp;|&nbsp; uor.edu.krd</p>',
