...
return [
    ...
    'hero_eyebrow' => '<h2 style="font-size:clamp(1rem,3vw,1.3rem);">Welcome To</h2>
...
<div class="text-center p-5 bg-white rounded-xl shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"><h4 class="text-[#2d2d3a] mb-2 font-bold">MAHMOOD KHDIR FAQE RASUL</h4><p class="text-[#6b6b80]">Biology Department Student - Web Developer</p><div class="social-placeholder"></div></div>
    ...
    'services_heading' => '<h2 class="font-bold text-[#2d2d3a] mb-8 text-center" style="font-size:clamp(1.7rem,4.5vw,2.4rem);">📚 History of the College of Science Library</h2>
<div class="relative rounded-[18px] overflow-hidden shimmer-border reveal"
style="background: linear-gradient(145deg, #f5f7ff 0%, #eef0f8 100%); padding: clamp(1.5rem,5vw,3rem); box-shadow: 0 8px 32px rgba(102,126,234,0.15);">
...
<p class="text-[#6b6b80] mb-0 italic text-justify" style="font-size:clamp(0.95rem,2.5vw,1.15rem); font-style: italic;"> &ldquo; Opening the door to information for every student and providing a single platform that meets all academic needs in a modern and contemporary manner &ldquo;</p>
    ...
    'feedback_error' => 'Please write your feedback or suggestion.',
    'feedback_title' => '💬 Feedback & Suggestions',
    'feedback_subtitle' => 'Share your opinion with us to help improve the library.',
    'fb_name_label' => 'Name (optional)',
    'fb_msg_label' => 'Feedback or suggestion',
    'fb_send' => 'Send',
    'footer_copyright' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">College of Science Electronic Library - Raparin University &nbsp;|&nbsp; All rights reserved &copy; <span class="footer-year-en"></span></p>',
    'footer_uor_link' => '<p style="font-size:clamp(0.85rem,2vw,0.95rem);">🎓 <a href="https://uor.edu.krd" target="_blank" rel="noopener" style="color:#9bb1ff; text-decoration:underline; text-underline-offset:3px;">University of Raparin Website</a> &nbsp;|&nbsp; uor.edu.krd</p>',
